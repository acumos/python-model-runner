...
setup(
    ...
    install_requires=['acumos>=0.5.3',
                      'lark-parser<0.8',
                      # try to use connexion 2, fallback to connexion 1 if running in python < 3.6
                      'connexion~=2.6 ; python_version >= "3.6"',
                      'connexion<2.0.0 ; python_version < "3.6"',
                      'werkzeug<1.0.0 ; python_version < "3.6"',
                      'swagger_ui_bundle ; python_version < "3.6"',
                      'gunicorn',
                      'pyyaml',
                      'jinja2',
                      'protobuf',
