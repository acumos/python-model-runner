...
def create_app(model_dir, host, port, workers=1, timeout=120):
    '''Creates and returns the model runner application
    ...
    return StandaloneApplication(model_dir, host, port, workers, timeout)
...
class StandaloneApplication(BaseApplication):
    ...
    def __init__(self, model_dir, host, port, workers, timeout):
